    ...
    <div class='container' @click='back'>
        <div class='row'>
            <div class='col-sm-12 col-md-12 mt-5 mb-5'>
                <svg fill='none' viewBox='0 0 636 324' width='100%'
                    ...
                    <g id='OBJECTS'>
                        ...
                        <g id='Group_8'>
                            <g id='Group_9'>
                                ...
                                <path id='Vector_62' d='M562 209.6L564.7 237.9'
                                      opacity='0.25'
                                      stroke='white'
                                      stroke-dasharray='1.39 1.39'
                                      stroke-linecap='round'
                        ...
                        <g id='Group_13'>
                            <g id='Group_14'>
                                ...
                                <path id='Vector_111'
                                      ...
                                      stroke-miterlimit='10'
                                      stroke-width='0.4635' />
                                <path id='Vector_112' d='M96.5 204.6L98.7 241.6'
                                      opacity='0.25'
                                      stroke='white' stroke-linecap='round'
                                      stroke-linejoin='round'
                                      stroke-miterlimit='10'
                                ...
                                <path id='Vector_113'
                                      ...
                                      fill='black'
                                      opacity='0.25' />
                                <path id='Vector_114' d='M87.4 213L84.3 243.2'
                                      opacity='0.25'
                                      stroke='white' stroke-linecap='round'
                                      stroke-linejoin='round'
                                      stroke-miterlimit='10'
                        ...
                        <g id='Group_25'>
                            ...
                            <path id='Vector_125'
                                  ...
                                  stroke='#1F3247' stroke-miterlimit='10'
                                  stroke-width='0.9271' />
                            <g id='Group_26'>
                                <path id='Vector_126'
